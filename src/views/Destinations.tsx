...
export default function Offers() {
  ...
  const filteredOffers = offers.filter((offer) => (offer.type.includes(selectedType) || selectedType === "") && (offer.description.toLowerCase().includes(searchQuery.toLowerCase()) || offer.localisation.toLowerCase().includes(searchQuery.toLowerCase())));
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2">
              ...
              <div className="relative">
                <input type="text" placeholder="Rechercher une offre..." className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
            ...
            <div>
              ...
              <div className="relative">
                <input type="date" className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} />
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" value={selectedType} onChange={(e) => setSelectedType(e.target.value)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredOffers.map((offer, index) => (
            <div key={offer._id} className="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 animate-fade-in" style={{ animationDelay: `${index * 100}ms` }}>
              <div className="relative pb-48 overflow-hidden">
                <img className="absolute inset-0 h-full w-full object-cover transform hover:scale-105 transition-transform duration-300" src={offer.pictures[0] || "/placeholder.svg?height=400&width=600"} alt={offer.type} />
              </div>
              <div className="p-6">
                ...
                <button
                  className={`w-full py-2 px-4 rounded-md flex items-center justify-center transition-all duration-300 ${
                    offer.disponibility ? "bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 transform hover:scale-105" : "bg-gray-300 text-gray-500 cursor-not-allowed"
                  }`}
                  onClick={() => {
